...
class bus_booking:
    ...
    def home_page(self):
        ...
        Label(root, text='\n').grid(row=5, column=8)
        Label(root, text='For Admin Only', fg='red').grid(row=8, column=8)
    ...
    def check_booking_page(self):
        ...
        def check_tkt():
            ...
            if len(mobile)==10 and mobile.isdigit():
                ...
                Label(text="booking ref = "+b_ref,font='Arial 12 bold', fg='black').grid(row=7,column=4)
                Label(text="Passenger = " + name, font='Arial 12 bold', fg='black').grid(row=7, column=5)
                Label(text="gender = " + gen, font='Arial 12 bold', fg='black').grid(row=8, column=4)
                Label(text="No. of seats = " + str(seat), font='Arial 12 bold', fg='black').grid(row=8, column=5)
                Label(text="Age = " + str(age), font='Arial 12 bold', fg='black').grid(row=8, column=6)
                Label(text="booked on = " + book_date, font='Arial 12 bold', fg='black').grid(row=9, column=4)
                Label(text="travel date = " + travel_date, font='Arial 12 bold', fg='black').grid(row=9, column=5)
                Label(text="fare = " + str(fare), font='Arial 12 bold', fg='black').grid(row=10, column=4)
                Label(text="total fare = " + str(fare*seat), font='Arial 12 bold', fg='black').grid(row=10, column=5)
        ...
        Label(root, text="Online Bus Booking System", font='Arial 28 bold', bg='sky blue', fg='red').grid(row=2,
                                                                                                         ...
                                                                                                         columnspan=12,
                                                                                                         pady=20)
        Label(root, text="Check Your Booking", font='Arial 22 bold', bg='lightgreen', fg='black').grid(row=3,
                                                                                                            column=0,
                                                                                                            pady=20,
                                                                                                            columnspan=12,
                                                                                                            padx=600)
